...
void PointCloudAligner::computeDensifiedPCLs( const std::string& fixed_cloud, const std::string& moving_cloud, const cv::Size& outp_img_size ){
...
void PointCloudAligner::MatchGoICP(const string &cloud1_name, const string &cloud2_name){
...
void PointCloudAligner::downsamplePointClouds(const std::string& cloud1_name, const std::string& cloud2_name){
...
FImage PointCloudAligner::computeSiftCorrespondeces(const std::string& cloud1_name, const std::string& cloud2_name, const MatchingType &type){
