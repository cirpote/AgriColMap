addpath('20180524-mavic-ugv-soybean-eschikon-row4/CPD_Comparison');

GroundTruth = load("20180524-mavic-ugv-soybean-eschikon-row4_AffineGroundTruth.txt");
AffesultsList = fileread("row4_CPD_list.txt");
